...
#ifdef _WIN32
#include <windows.h>
static void menu_delay_ms(unsigned ms) { Sleep(ms); }
#else
#include <unistd.h>
static void menu_delay_ms(unsigned ms) { usleep((useconds_t)ms * 1000u); }
#endif
...
void show_exercise_menu(void)
{
    ...
    while (1)
    {
        ...
        switch (user_choice)
        {
            ...
            case 16: run_exercise_16(); break;
            case 17: run_exercise_17(); break;
            case 18: run_exercise_18(); break;
            case 19: run_exercise_19(); break;
            case 20: run_exercise_20(); break;
            case 21: run_exercise_21(); break;
